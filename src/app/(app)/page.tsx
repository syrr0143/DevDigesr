    ...
    <div>
      ...
      <div className=' rounded-3xl h-[100vh] justify-center items-center flex'>
        <div className='  text-black'>
          <h2 className='text-4xl font-extrabold '>The powerful infrastructure behind your blog
          </h2>
          <div className="flex flex-wrap mt-16">
            ...
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
              ...
              <p>
                ...
                With free website hosting on a worldwide CDN, your site is automatically backed up and will be able to handle any situation - from traffic spikes to outages - so you’ll always be up and running.</p>
            </div>
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
              <div className='divider'></div>
              ...
              <p>
                ...
                We have a performance-first culture, meaning our priority is providing the best user experience for you and your visitors, with faster loading sites that perform great on any device.</p>
            </div>
      ...
      <div className='bg-gray-100 rounded-3xl h-[100vh] justify-center items-center flex'>
        <div className='  text-black'>
          <h2 className='text-4xl font-extrabold '>5 easy steps to start going...
          </h2>
          <div className="flex flex-wrap mt-16">
            <div className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
